...
class MusicPlayer extends FlxGroup 
{
	...
	public function switchPlayMusic()
	{
		...
		if (playingMusic)
		{
			instance.bottomText.text = Language.getPhrase('musicplayer_tip', "Press SPACE to Pause the Song. / Press ESCAPE to Exit the Music Player. / Press RESET to Reset the Song's position.");
			positionSong();
