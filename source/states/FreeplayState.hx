...
class FreeplayState extends MusicBeatState
{
	...
	override function create()
	{
		...
		{
			var songText:Alphabet = new Alphabet(90, 350, songs[i].songName, true);
			songText.targetY = i;
		...
		var leText:String = Language.getPhrase("freeplay_tip", "Press SPACE to listen to the Song. / Press CTRL to open the Modifer Menu. / Press RESET to Reset your Score and Accuracy.");
		bottomString = leText;
		var size:Int = 16;
